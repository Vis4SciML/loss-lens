...
from loss_landscapes.model_interface.model_parameters import orthogonal_to_plane, rand_u_like, rand_n_like, orthogonal_to
...
# noinspection DuplicatedCode
def random_plane_hessian(model: typing.Union[torch.nn.Module, ModelWrapper], metric: Metric, dir_one: ModelParameters, dir_two: ModelParameters, distance=1, steps=20,
                 normalization='filter', deepcopy_model=False) -> np.ndarray:
    model_start_wrapper = wrap_model(copy.deepcopy(model) if deepcopy_model else model)
